<?php
/*
 * Template Name: PDF-CUADERNOS MYBOOK 1.0
 * Version: 1.0
 * Description: cuadernos MYBOOK pdf
...
<div class="container">
    ...
    <table class="table">
        <thead class="thead-dark">
            <tr>
                <th colspan="4" scope="col" class="titulos">Cuadernos MyBook</th>
            </tr>
        </thead>
        <tbody>
            <tr>
            ...
            <tr>
                <td><b>Nombre:</b> {Nombre de la portada:145}</td>
                <td><b>Extendido:</b> {Nombre de la portada:146}</td>
                <td><b>Tintas:</b> {Tintas de portada de cuadernos:148}</td>
                <td><b>Páginas:</b> {Numero de forros de la portada del cuaderno:147}</td>
            </tr>
            <tr>
                <td>
                    <b>Recubrimiento:</b> {Recubrimiento portada de cuadernos:150}
                </td>
                <td>
                    <b>Tipo de papel:</b> {Tipo de papel de la portada cuadernos:149}
                </td>
            </tr>
        </tbody>
    </table>
