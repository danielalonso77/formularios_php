...
<div class="container">
    ...
    [gravityforms action="conditional" merge_tag="{¿Cuantos tipos de papel diferente tendrá los interiores?:56}"
    condition="isnot" value=""]
    <table class="table">
        <thead class="thead-dark">
            <tr>
                <th colspan="9" scope="col" class="titulos">Interiores - 1</th>
            </tr>
            <tr>
                <th colspan="9" scope="col" class="titulos">Tipo de papel (1)</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td colspan="1"><b>Número de páginas</b> {Número de páginas del interior - (1):57}
                </td>
                <td colspan="1"><b>Tipo de papel</b> {Tipo de papel - (1):59}
                </td>
                <td colspan="1"><b>Tintas</b> {Tintas de interior - (1):60}

                </td>
            </tr>
            <tr>
                <td colspan="1"><b>Recubrimiento Barniz</b> {Recubrimiento de interior - (1):61}
                </td>
            </tr>
            <tr>
                <td colspan="1"><b>Acabados especiales</b> {Acabado especial interior - (1):62}
                </td>
            </tr>
        </tbody>
    ...
    <table class="table">
        <thead class="thead-dark">
            <tr>
                <th colspan="9" scope="col" class="titulos">Interiores - 2</th>
            </tr>
            <tr>
                <th colspan="9" scope="col" class="titulos">Tipo de papel (2)</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td colspan="1"><b>Número de páginas</b> {Número de páginas del interior - (2):63}
                </td>
                <td colspan="1"><b>Tipo de papel</b> {Tipo de papel - (2):64}
                </td>
                <td colspan="1"><b>Tintas</b> {Tintas de interior - (2):65}

                </td>
            </tr>
            <tr>
                <td colspan="1"><b>Recubrimiento Barniz</b> {Recubrimiento de interior - (2):66}
                </td>
            </tr>
            <tr>
                <td colspan="1"><b>Acabados especiales</b> {Acabado especial interior - (2):67}
                </td>
            </tr>
        </tbody>
    ...
    <table class="table">
        <thead class="thead-dark">
            <tr>
                <th colspan="9" scope="col" class="titulos">Interiores - 3</th>
            </tr>
            <tr>
                <th colspan="9" scope="col" class="titulos">Tipo de papel (2)</th>
            </tr>
        ...
        <tbody>
            <tr>
                <td colspan="1"><b>Número de páginas</b> {Número de páginas del interior - (3):69}
                </td>
                <td colspan="1"><b>Tipo de papel</b> {Tipo de papel - (3):70}
                </td>
                <td colspan="1"><b>Tintas</b> {Tintas de interior - (3):71}

                </td>
            </tr>
            <tr>
                <td colspan="1"><b>Recubrimiento Barniz</b> {Recubrimiento de interior - (3):72}
                </td>
            </tr>
            <tr>
                <td colspan="1"><b>Acabados especiales</b> {Acabado especial interior - (3):73}
                </td>
            </tr>
        </tbody>
    ...
    <td colspan="2" align="right">
        <table>
            ...
            <tr>
                ...
                <td><b>$</b><?php $precio_total = echo number_format((float)$form_data['field'][34], 2, '.', ',');?></td>
            </tr>
            <?php endif; ?>
            <?php if ( $subtotal != '' ): ?>
            <tr>
                <td><b>Subtotal:</b></td>
                <td><b>$</b><?php echo $subtotal = number_format((float)$form_data['field'][35], 2, '.', ',');?></td>
            </tr>
            <tr>
                <?php endif; ?>
                <?php if ( $iva != '' ): ?>
                <td><b>IVA:</b></td>
                <td><b>$</b><?php echo $iva = number_format((float)$form_data['field'][37], 2, '.', ',');?></td>
            </tr>
            <?php endif; ?>
            <?php if ( $total_uno != ''):?>
            <tr>
                <td><b>TOTAL</b></td>
                <td><b>$</b><?php echo $total = number_format((float)form_data['field'][38], 2, '.', ','); ?></td>
            </tr>
            <?php endif; ?>
