...
<div class="container">
    ...
    <table class="table">
        <thead class="thead-dark">
            <tr>
                <th colspan="9" scope="col" class="titulos">Portada - Agendas</th>
            </tr>
        </thead>
        <tbody>
            <tr colspan="2">
                <td scope="col"><b>Cantidad Solicitada</b> {Cantidad Solicitada:145}
                </td>
                <td scope="col"><b>Numero total de páginas</b> {Número total de páginas:145}
                </td>
                <td scope="col"><b>Tipo de encuadernado</b> {Tipo de encuadernado:148}
                </td>
            </tr>
            <tr>
    ...
    [gravityforms action="conditional" merge_tag="{¿Cuantos tipos de papel diferentes tenrda?:154}" condition="isnot" value=""]
    <table class="table">
        <thead class="thead-dark">
            <tr>
        ...
        <tbody>
            <tr>
                <td colspan="1"><b>Tipo de papel</b> {Cantidad solicitada:156}
                </td>
                <td colspan="1"><b>Número de páginas</b> {Número de páginas:158}
                </td>
                <td colspan="1"><b>Tintas</b> {Tintas:160}

            </tr>
            <tr>
                <td colspan="1"><b>Recubrimiento Barniz</b> {Recubrimiento:161}
                </td>
                <td colspan="1"><b>Acabados especiales</b> {Acabados especiales:163}
                </td>
            </tr>
    ...
    <table class="table">
        <thead class="thead-dark">
            <tr>
                <th colspan="9" scope="col" class="titulos">Tipo de papel (2) {Tipo de papel (2) - 163}</th>
            </tr>

        </thead>
        <tbody>
            <tr>
                <td colspan="1"><b>Tipo de papel</b> {Tipo de papel - (2):172}
                </td>
                <td colspan="1"><b>Número de páginas</b> {Número de páginas Interior:164}
                </td>
                <td colspan="1"><b>Tintas</b> {Tintas:166}

            </tr>
            <tr>
                <td colspan="1"><b>Recubrimiento Barniz</b> {Recubrimiento:167}
                </td>
                <td colspan="1"><b>Acabados especiales</b> {Acabados especiales:168}
                </td>
            </tr>
    ...
    <table class="table">
        <thead class="thead-dark">
            <tr>
                <th colspan="9" scope="col" class="titulos">Tipo de papel (3) {Tipo de papel (3) - 169}</th>
            </tr>

        </thead>
        <tbody>
            <tr>
                <td colspan="1"><b>Tipo de papel</b> {Tipo de papel - (3):173}
                </td>
                <td colspan="1"><b>Número de páginas</b> {Número de páginas Interior:170}
                </td>
                <td colspan="1"><b>Tintas</b> {Tintas:174}

            </tr>
            <tr>
                <td colspan="1"><b>Recubrimiento Barniz</b> {Recubrimiento:175}
                </td>
                <td colspan="1"><b>Acabados especiales</b> {Acabados especiales:176}
                </td>
            </tr>
